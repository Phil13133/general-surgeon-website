          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Γιατί να Επιλέξετε τον Δρ. Κωστογλάνη
              </h2>
            ...
            {[
              {
                ...
                testimonial:
                  "Ο Δρ. Κωστογλάνης με βοήθησε να ξεπεράσω το πρόβλημά μου με τη χολή. Η λαπαροσκοπική επέμβαση ήταν απόλυτα επιτυχημένη και η ανάρρωσή μου ήταν πολύ γρήγορη.",
                rating: 5,
                avatar: "ΜΠ"
              },
              {
              ...
              },
              {
                ...
                testimonial:
                  "Ο Δρ. Κωστογλάνης είναι ένας εξαιρετικός χειρουργός με μεγάλη εμπειρία. Η επέμβαση στον θυρεοειδή μου έγινε με απόλυτη επιτυχία.",
                rating: 5,
                avatar: "ΕΓ"
              },
            ].map((testimonial, i) => (
